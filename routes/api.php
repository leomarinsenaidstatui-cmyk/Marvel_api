...
Route::post('/solicitar_codigo_recuperacao', [UsuarioController::class, 'solicitar_codigo_recuperacao']);
Route::post('/confirmar_codigo_recuperacao', [UsuarioController::class, 'confirmar_codigo_recuperacao']);
Route::post('/resetar_senha', [UsuarioController::class, 'resetar_senha']);
